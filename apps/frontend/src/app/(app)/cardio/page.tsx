      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-white flex items-center gap-3 uppercase tracking-wide">
            <Activity className="w-7 h-7 text-[#DC143C]" />
            Campo
          </h1>
        ...
        <motion.button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-[#DC143C] text-white rounded-xl font-semibold text-sm flex-shrink-0"
