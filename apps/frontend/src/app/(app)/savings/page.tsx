      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-3 uppercase tracking-wide">
            <Sword className="w-8 h-8 text-[#DC143C]" />
            Coliseo
          </h1>
        ...
        <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-[#DC143C] text-white rounded-xl font-black text-sm uppercase tracking-wide"
